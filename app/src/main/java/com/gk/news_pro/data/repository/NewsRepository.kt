...
class NewsRepository {
    ...
    suspend fun getNews(apiKey: String, query: String? = null, category: String? = null,language: String? = null): NewsResponse {
        return newsApiService.getNews(apiKey, query, category,language)
    }
}
